...
@section('content')
                    ...
                    <li class="da-slider">
                        <div class="da-slide row">
                            <div class="span5">
                                ...
                                <p>Thank you for visiting the Foldagram! As you explore the site and create your
                                    Foldagram, !</p>
                                <a href="#popup" data-toggle="modal" class="da-link create btn">Click Here to Get
                                    Started!</a>
                                <a href="#video" class="da-link video btn" data-toggle="modal">See the Foldagram Video!</a>
                            </div>
                            <div class="da-img span7">
                                <img src="{{ asset('img/slide3.png') }}" alt="image01"/>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="da-slide row">
                            <div class="span5">
                                ...
                                <p>Wether you're travelling in South America, China, or your own neighborhood,
                                    Foldagrams are always</p>
                                <a href="#popup" data-toggle="modal" class="da-link create btn">Click Here to Get
                                    Started!</a>
                                <a href="#video" class="da-link video btn" data-toggle="modal">See the Foldagram Video!</a>
                            </div>
                            <div class="da-img span7">
                                <img src="{{ asset('img/slide2.png') }}" alt="image01"/>
                            </div>
                        </div>
                    </li>
                </ul>
    ...
    <div class="row-fluid fguid">
        ...
        <div class="span4 we-send">
            <h2>We Send</h2>
            <img src="{{ asset('img/fly.png') }}" alt="fly">
            <ul>
