...
@section('inner-banner')
    <div class="row-fluid inner-top">
        ...
        <img src="{{ asset('img/inner-folder.png') }} ">
    </div>
@stop
...
@section('content')
    <div class="span12 dcontent">
        ...
        <div class="span5 well">
            ...
            <p>
                <a href="http://www.coloradocountrylife.com/index.php?option=com_content&view=article&id=1068:send-a-letter&catid=39:other-resources&Itemid=91">Colorado
                    Country Life</a>
            </p>
