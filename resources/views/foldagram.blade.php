<div id="popup" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        <div class="cfrom-wapper">
            <img src="{{ asset('img/create-form-flow.png') }}" alt="create form flow">

            {{ Form::open( array('url' => URL::route('about') )) }}

            <div class="setp1">
                <div class="message create-form">
                    <textarea rows="4" class="enter-message required" placeholder="Enter Your Message: *" name="message"
                              cols="50"></textarea>
            ...
            <div class="address">
                <div class="alert alert-error" style="display: none;"><a href="#" class="close">×</a>Message Field
                    Required and Upload Foldagram Image.
                </div>
                <div class="photocreate-form recipient_address_wapper">
                    ...
                    <div class="recipient_address" id="recip_1">
                        ...
                        <input placeholder="Full Name* :" class="required " type="text" name="add[0][fullname]"
                               value="">
                        <textarea placeholder="Enter Recipient's Address here  * :" rows="8" class="required "
            ...
            <div class="submit">
                <div class="submit-content">
                    ...
                    <button class="remove btn-large btn" type="button" style="display: none;">Remove Address</button>
                    <br>
